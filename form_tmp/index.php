    ...
    -->
        <form action="confirm.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="name" value="<?php if($_POST['name']){echo $_POST['name'];} ?>">
            </div>
            <div class="mb-3">
                <label for="emaile" class="form-label">メールアドレス</label>
                <input name="email" type="email" class="form-control" value="<?php if($_POST['email']){echo $_POST['email'];} ?>">
            </div>
            <div class="mb-3">
                <label for="number" class="form-label">電話番号</label>
                <input name="number" type="text" class="form-control" id="number" value="<?php if($_POST['number']){echo $_POST['number'];} ?>">
            <div class="mb-3">
